    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                ...
                <!-- 公告 -->
                @if(Auth::user()->type == 0 or Auth::user()->type == 1 or Auth::user()->type == 3)
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">作業 </span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        @if(Auth::user()->type == 3)
                            ...
                            <li class="sidebar-item"><a href="{{ route('assignment.manageAssignments_Teacher') }}" class="sidebar-link"><i class="mdi mdi-all-inclusive"></i><span class="hide-menu"> 當學期作業列表 </span></a></li>
                        @endif
                    </ul>
                </li>
                @endif
