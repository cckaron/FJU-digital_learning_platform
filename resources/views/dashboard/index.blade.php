        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets scrollable">
                            ...
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><img src="{{ URL::to('images/users/4.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><img src="{{ URL::to('images/users/5.jpg') }}" alt="user" width="50" class="rounded-circle"></div>
                                <div class="comment-text w-100">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title m-b-0">平台資訊</h4>
                            <div class="m-t-20">
