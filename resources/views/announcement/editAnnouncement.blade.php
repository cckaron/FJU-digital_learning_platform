    ...
    <!-- ============================================================== -->
        ...
        <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <form action="{{ route('teacher.announcement.edit', ['id' => $announcement->id]) }}" method="post" id="editAnnouncement" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="announcementTitle" class="form-control" placeholder="標題" name="announcementTitle" value="{{ $announcement->title }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input" id="topPost" name="topPost" @if($announcement->priority == 0) checked @endif>
