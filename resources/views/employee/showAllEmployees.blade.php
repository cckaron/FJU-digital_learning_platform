...
@section('content')
    ...
    <!-- ============================================================== -->
        ...
        @include('layouts.partials.pageBreadCrumb', ['title' => '所有工讀生'])
                                        ...
                                        <table id="zero_config" class="table table-striped table-bordered">
                                            ...
                                            @foreach($employees as $employee)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('user.deleteEmployee', ['id' => $employee->id]) }}" class="btn btn-danger btn-sm" onclick="return confirm('確定刪除?')" style="margin-bottom: 5px;">
                                                            刪除
                                                        </a>
                                                    </td>
                                                </tr>
