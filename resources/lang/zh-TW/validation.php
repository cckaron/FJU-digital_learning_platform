...
return [
    ...
    */
    ...
    'custom' => [
        ...
        //新增作業 (createAssignment)
        'assignmentName' => [
            'required' => '作業名稱 不能留空'
        ],
        'assignmentStart' =>  [
            'required' => '開放繳交時間 不能留空',
            'date' => '請輸入正確的日期格式 (年/月/日)',
            'date-format' => '開放繳交時間 不符合 (年/月/日) 的格式',
            'before' => '開放繳交時間 必須要早於 截止時間'],
        'assignmentEnd' => [
            'required' => '截止時間 不能留空',
            'date' => '請輸入正確的日期格式 (年/月/日)',
            'date-format' => '截止時間 不符合 (年/月/日) 的格式',
            'after' => '截止時間 必須要晚於 開放繳交時間'],
        ...
        'courseStart' =>  [
            'required' => '開課時間 不能留空',
            'date' => '請輸入正確的日期格式 (年/月/日)',
            'date-format' => '開課時間 不符合 (年/月/日) 的格式',
            'before' => '開課時間 必須要早於 課程結束時間'],
        'courseEnd' => [
            'required' => '課程結束時間 不能留空',
            'date' => '請輸入正確的日期格式 (年/月/日)',
            'date-format' => '課程結束時間 不符合 (年/月/日) 的格式',
            'after' => '課程結束時間 必須要晚於 開課時間'],
